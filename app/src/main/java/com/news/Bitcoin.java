...
public class Bitcoin extends Fragment {
    ...
    Date d = new Date();
    String date  = (String) DateFormat.format("yyyy MMMM d,  ", d.getTime());
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = view.findViewById(R.id.show_bitcoin_news);
    ...
    private void getData(){
        ...
        Call<Data> response = service.getData("bitcoin",date,"publishedAt","2d832b6251834cd29b6581f8ce28d0e3");
