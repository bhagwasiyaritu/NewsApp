...
public class Apple extends Fragment {
    ...
    Date d = new Date();
    String date1  = (String) DateFormat.format("yyyy MMMM d,  ", d.getTime());
    String date2  = (String) DateFormat.format("yyyy MMMM d,  ", d.getTime());
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = view.findViewById(R.id.show_apple_news);
    ...
    private void getData(){
        ...
        Call<Data> response = service.getData("apple",date1,date2,"popularity","2d832b6251834cd29b6581f8ce28d0e3");
